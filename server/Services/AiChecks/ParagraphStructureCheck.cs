...
/// <summary>
/// Analyzes paragraph length consistency.
/// AI produces very evenly-sized paragraphs with similar structure.
/// Human writing has much more variability in paragraph length.
/// </summary>
public partial class ParagraphStructureCheck : IAiCheck
{
    ...
    public Task<AiCheckResult> RunAsync(string text)
    {
        ...
        // Check if paragraphs start with similar patterns (e.g., "The", "It", "This")
